...
export default function Register() {
  ...
  const handleCNPJChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (numerosSomente.length <= 14) {
      const cnpjMascarado = numerosSomente.length > 0 
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-start py-8">
      ...
      <div className='flex flex-col items-center justify-center mt-4 mb-2 mx-auto w-98 bg-white rounded-2xl shadow-2xl p-6'>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className='w-80 flex flex-col gap-4'>
          <AnimatePresence mode="wait">
            {step === 1 && (
              ...
              <div>
                ...
                />
                {errors.nomeOng && (
                  <span className="text-red-500 text-sm mt-1 block">{errors.nomeOng.message}</span>
                )}
              </div>
              ...
              <div>
                ...
                />
                {errors.cnpj && (
                  <span className="text-red-500 text-sm mt-1 block">{errors.cnpj.message}</span>
                )}
              </div>
            ...
            {step === 2 && (
              ...
              {/* Nome do Respons?vel */}
              <div>
                <label className="spanLogin block mb-2">Nome do Responsável</label>
                <input
                  type="text"
                ...
                {errors.nomeResponsavel && (
                  <span className="text-red-500 text-sm mt-1 block">{errors.nomeResponsavel.message}</span>
                )}
              </div>
              ...
              {/* Confirmar Senha */}
              <div className="relative">
                <label className="spanLogin block mb-2">Confirmar Senha</label>
                <input
      ...
      <div className="flex mt-4">
        ...
        <Link href="/" className="text-purple-600 font-bold hover:text-purple-800 text-xl ml-2">
          Entrar na conta
        </Link>
      </div>
    </div>
