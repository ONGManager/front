...
export default function ForgotPassword() {
  return (
    <div className="min-h-screen align-middle flex flex-col justify-center items-center">
        <LoginPadrao Titulo="Esqueceu sua senha?" 
        ...
        <div className='flex flex-col items-center justify-center mt-8 mb-4 mx-auto w-98 h-50 bg-white border border-gray-300 rounded-2xl shadow-2xl p-6'>
            ...
            <Button variant="contained" color="primary" className='w-80 h-10 bg-purple-600! hover:bg-purple-700! text-white'>Enviar link de Recuperação</Button>
        </div>
        <div className='flex'>
          <p className='SubTitulo'>Lembrou sua senha?</p>
          <a href="/." className='text-xl text-purple-600 font-bold hover:text-purple-800 ml-2'>Entrar na conta</a>
        </div>
    </div>
  );
}
