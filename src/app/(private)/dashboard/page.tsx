...
import Grafico1 from "@/src/components/Grafico1";
import QntdFunc from "@/src/components/QntdFunc";
import TaskFinish from "@/src/components/TaskFinish";
  ...
  return (
    <div>
      <div className="mb-6">
        ...
        <p className="text-[var(--muted)]">Bem-vindo ao {ong?.name}</p>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {/* Card Kanban */}
        <Link href="/kanban" className="block">
          <div className="bg-[var(--surface)] rounded-lg shadow-lg p-6 hover:shadow-xl transition-shadow cursor-pointer border-l-4 border-purple-600">
            <div className="flex items-center mb-4">
              ...
              <h2 className="text-xl font-semibold ml-3 text-[var(--text)]">
                Tarefas
              </h2>
            </div>
        ...
        {isAdmin && (
          <Link href="/members" className="block">
            <div className="bg-[var(--surface)] rounded-lg shadow-lg p-6 hover:shadow-xl transition-shadow cursor-pointer border-l-4 border-green-600">
              <div className="flex items-center mb-4">
                <svg
        ...
        <div className="bg-[var(--surface)] rounded-lg shadow p-6 opacity-50">
          <div className="flex items-center mb-4">
            <svg
            ...
            <h2 className="text-xl font-semibold ml-3 text-[var(--muted)]">
              Relatórios
            </h2>
          </div>
