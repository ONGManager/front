...
export default function Sidebar({ userRole = "colaborador" }: SidebarProps) {
  ...
  return (
    <aside className="w-[220px] min-w-[220px] h-screen bg-[var(--surface)] border-r border-[var(--surface-border)] flex flex-col px-3 py-4 gap-0.5">
      {/* Logo */}
      <div className="flex items-center gap-2 px-2 pb-4 mb-2 border-b border-[var(--surface-border)]">
      ...
      <div className="mt-auto pt-3 border-t border-[var(--surface-border)] flex flex-col gap-0.5">
        ...
        <button
          ...
          className="flex items-center gap-2.5 px-2.5 py-2 rounded-lg text-[13px] text-[var(--muted)] hover:bg-[var(--danger-soft)] hover:text-[var(--danger)] transition-colors w-full text-left"
        >
          Sair
        </button>
      </div>
